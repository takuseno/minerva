...
@project_route.route(
    "/<project_id>/experiments/<experiment_id>", methods=["GET"]
)
...
def create_experiment(project_id):
    ...
    experiment = Experiment.create(
        project_id, name, log_name, json.dumps(config)
    )
...
@project_route.route(
    "/<project_id>/experiments/<experiment_id>", methods=["PUT"]
)
...
@project_route.route(
    "/<project_id>/experiments/<experiment_id>", methods=["DELETE"]
)
...
@project_route.route(
    "/<project_id>/experiments/<experiment_id>/cancel", methods=["POST"]
)
...
@project_route.route(
    "/<project_id>/experiments/<experiment_id>/download", methods=["GET"]
)
